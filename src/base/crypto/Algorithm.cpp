...
const char *Algorithm::kRX_EPIC         = "rx/epic";
#endif
...
const char *Algorithm::kPAUSE           = "pause";
...
#   ifdef XMRIG_ALGO_RANDOMX
    ...
    ALGO_ALIAS_AUTO(RX_EPIC),       ALGO_ALIAS(RX_EPIC,         "randomx/epic"),
                                    ALGO_ALIAS(RX_EPIC,         "randomepic"),
#   endif
...
std::vector<xmrig::Algorithm> xmrig::Algorithm::all(const std::function<bool(const Algorithm &algo)> &filter)
{
    static const std::vector<Id> order = {
        ...
        CN_UPX2,
        RX_0, RX_WOW, RX_ARQ, RX_GRAFT, RX_SFX, RX_KEVA, RX_EPIC,
